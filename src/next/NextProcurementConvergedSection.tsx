...
function renderPreventivoReceiptBadges(entry: {
  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 6 }}>
      {entry.ricevutoDaWhatsapp ? <span style={badgeStyle}>✓ WhatsApp</span> : null}
      {entry.ricevutoDaEmail ? <span style={badgeStyle}>✓ Email</span> : null}
    </div>
  );
}
