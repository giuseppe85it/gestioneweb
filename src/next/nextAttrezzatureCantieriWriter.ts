/**
 * Writer NEXT per Attrezzature Cantieri.
 * Estratto da NextAttrezzatureCantieriWritePanel.tsx in Step E.1bis.
 * Nessuna logica cambia rispetto a E.1.
 * SPEC: docs/product/SPEC_ATTREZZATURE_CANTIERI_NEXT.md Sezione 5.
 */
...
export type AttrezzaturaMovimentoRecord = {
  id: string;
...
export async function uploadFotoMovimento(params: {
  movimentoId: string;
  fotoFile: File;
...
export async function deleteFotoMovimento(params: DeleteFotoMovimentoParams): Promise<void> {
...
export async function createMovimentoAttrezzatura(
  params: CreateMovimentoAttrezzaturaParams,
): Promise<void> {
...
export async function editMovimentoAttrezzatura(
  params: EditMovimentoAttrezzaturaParams,
): Promise<void> {
  const cantiereLabel =
...
export const saveEditMovimentoAttrezzatura = editMovimentoAttrezzatura;

export async function deleteMovimentoAttrezzatura(
...
export const removeEditFotoAttrezzatura = deleteFotoMovimento;
