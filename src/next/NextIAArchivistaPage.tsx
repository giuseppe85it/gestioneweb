...
function normalizePresetText(value: string | undefined) {
  return typeof value === "string" ? value.trim() : "";
}

function buildArchivistaPreloadDocument(preset: ArchivistaPreset | undefined) {
  const fileUrl = normalizePresetText(preset?.fileUrl);
  if (!fileUrl) {
    return null;
  }
  ...
  return {
    fileUrl,
    sourceDocId: normalizePresetText(preset?.sourceDocId) || undefined,
...
export default function NextIAArchivistaPage() {
  ...
  const archivistaPreloadDocument = useMemo(
    () => buildArchivistaPreloadDocument(navigationState?.archivistaPreset),
    [navigationState],
  );
    ...
    return (
      <section className="next-page internal-ai-page">
        <ArchivistaDocumentoMezzoBridge
          ...
          preloadDocument={archivistaPreloadDocument}
