...
## Stato del documento
- Versione: 0.5 BOZZA — alias e allowedFields allineati 2026-05-04
- Data: 2026-05-04
...
- Totale collection Firestore tracciate: 38
...
| `storage/@analisi_economica_mezzi` | BOUNDARY OPEN — RUNTIME PENDING — VERIFICA RINVIATA | Analisi economiche salvate per mezzo. |
...
| `storage/@documenti_generici` | BOUNDARY OPEN — RUNTIME PENDING — VERIFICA RINVIATA | Documenti generici Archivista. |
| `storage/@documenti_magazzino` | BOUNDARY OPEN — RUNTIME PENDING — VERIFICA RINVIATA | Documenti/costi magazzino. |
| `storage/@documenti_mezzi` | BOUNDARY OPEN — RUNTIME PENDING — VERIFICA RINVIATA | Documenti mezzo, libretti, fatture e manutenzioni archiviate. |
...
- **Campi-chiave**: `targa`, `id`, `autistaId`, `librettoStoragePath`.
...
- **Provenance per dati mostrati**: `targa`, `categoria`, `marca`, `modello`, `autistaId`, `librettoStoragePath`, date revisione/collaudo.
...
- **Note di validazione (per Giuseppe)**: VALIDATO 2026-05-04: dati economici mostrabili in chat certificata e in pannelli, nessuna policy di restrizione interna (utente unico admin del gestionale).
...
- **AllowedFields boundary**: id, cantiere, cantiereId, cantiereLabel, attrezzatura, attrezzaturaId, nome, tipo, stato, data, materialeCategoria, quantita, sourceCantiereId, sourceCantiereLabel, unita, createdAt, updatedAt.
- **Campi esclusi by design**: descrizione, fotoStoragePath, fotoUrl, note.
...
- **AllowedFields boundary**: id, codice, nome, articolo, materiale, categoria, quantita, unita, ubicazione, stockKey, fornitore, fornitoreLabel, nomeFornitore, prezzoUnitario, quantitaTotale, stockLoadKeys, updatedAt.
- **Campi esclusi by design**: descrizione, fotoStoragePath, fotoUrl, note.
