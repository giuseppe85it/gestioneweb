...
async function appendLavori(newItems: LavoroRecord[]) {
  ...
  async function saveAdminEdit() {
    ...
    if (adminEditKind === "rifornimento") {
      ...
      const dossierRecord = dossier as { items?: any[]; value?: { items?: any[] } };
      const items = Array.isArray(dossierRecord.items)
        ? dossierRecord.items
        : Array.isArray(dossierRecord.value?.items)
        ? dossierRecord.value.items
        : [];
