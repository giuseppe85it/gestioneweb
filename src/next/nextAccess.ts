...
export const NEXT_AREA_ACCESS: Record<NextAreaId, NextAreaAccessConfig> = {
  ...
  "anagrafiche": {
    permissionKey: "next.anagrafiche",
    allowedRoles: ["admin", "gestionale"],
    futureScope: "Modulo anagrafiche NEXT unificato per colleghi, fornitori e officine.",
  },
  "colleghi": {
