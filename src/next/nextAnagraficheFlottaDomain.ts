...
export const NEXT_FLOTTA_CANONICAL_CATEGORIES = [
  "motrice 2 assi",
  "motrice 3 assi",
  "motrice 4 assi",
  "trattore stradale",
...
function mapMezzoItem(args: {
  ...
  return {
    ...
    manutenzioneContrattoAttivo:
      raw.manutenzioneContrattoAttivo === false ? false : true,
...
function applyMezzoClonePatch(
  ...
  const merged = {
    ...
    manutenzioneContrattoAttivo:
      patch.manutenzioneContrattoAttivo ?? item.manutenzioneContrattoAttivo,
    manutenzioneDataInizio: manutenzioneDataInizio.value,
    manutenzioneDataInizioTimestamp: manutenzioneDataInizio.timestamp,
    manutenzioneDataFine: manutenzioneDataFine.value,
    manutenzioneDataFineTimestamp: manutenzioneDataFine.timestamp,
...
function buildMezzoFromClonePatch(args: {
  ...
  const raw = {
    ...
    manutenzioneContrattoAttivo: patch.manutenzioneContrattoAttivo ?? true,
