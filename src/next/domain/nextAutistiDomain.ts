...
function normalizeRichiestaSectionItem(
  ...
  return {
    ...
    evasa: record.evasa === true,
    dataEvasione: typeof record.dataEvasione === "number" ? record.dataEvasione : null,
    evasaBy: normalizeOptionalText(record.evasa_by),
    sourceDataset: RICHIESTE_KEY,
    sourceOrigin: "madre_storage",
    flags: [
      !targa.mezzo ? "missing_targa" : "",
