...
## Fonti pronte
- Le fonti guida piu usate per il clone/NEXT hanno una raccolta mirror in `docs/fonti-pronte/`.
- Se questa procedura viene aggiornata, nello stesso task va aggiornata anche la copia in `docs/fonti-pronte/PROCEDURA_MADRE_TO_CLONE.md`.
